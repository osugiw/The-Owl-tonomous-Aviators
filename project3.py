...
class MotorController:
    def __init__(self, speed_pin=18, steering_pin=19, _steering_direction=steering_forward):
        ...
        self.steering_pwm.start(_steering_direction) # Start with the specified duty cycle
